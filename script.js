window.addEventListener('load', function () {
  // Using classes or json file might be the next way to fix this sophmoric iteration of this
  // class Project {
  ...
  const purpose = this.document.getElementById('purpose');
  const objective = this.document.getElementById('objective');
  const approach = this.document.getElementById('approach');
  const projectDuration = this.document.getElementById('project-duration');
  const funFact = this.document.getElementById('fun-fact');
  ...
  //   wordpress: 'Wordpress',
  //   gis: 'GIS',
  //   productionTest: 'Production Test',
  //   gisCert: 'GIS Certificate Generator',
  // };

  myCarousel.addEventListener('slide.bs.carousel', (event) => {
    let id = event.relatedTarget.id;

    if (id === personalWebsite.projectTitle) {
      projectTitle.innerHTML = id;
      url.setAttribute('href', personalWebsite.url);
      url.setAttribute('target', '_blank');
      console.log(url);
      purpose.innerHTML = personalWebsite.purpose;
      objective.innerHTML = personalWebsite.objective;
      approach.innerHTML = personalWebsite.approach;
      projectDuration.innerHTML = personalWebsite.projectDuration;
      funFact.innerHTML = personalWebsite.funFact;
    }

    if (id === wordpress.projectTitle) {
      projectTitle.innerHTML = id;
      url.setAttribute('href', wordpress.url);
      url.setAttribute('target', '_blank');
      purpose.innerHTML = wordpress.purpose;
      objective.innerHTML = wordpress.objective;
      approach.innerHTML = wordpress.approach;
      projectDuration.innerHTML = wordpress.projectDuration;
      funFact.innerHTML = wordpress.funFact;
    }

    if (id === gis.projectTitle) {
      projectTitle.innerHTML = id;
      url.setAttribute('href', gis.url);
      url.removeAttribute('target');
      url.innerHTML = 'N/A';
      purpose.innerHTML = gis.purpose;
      objective.innerHTML = gis.objective;
      approach.innerHTML = gis.approach;
      projectDuration.innerHTML = gis.projectDuration;
      funFact.innerHTML = gis.funFact;
    }

    if (id === productionTest.projectTitle) {
      projectTitle.innerHTML = id;
      url.setAttribute('href', productionTest.url);
      url.setAttribute('target', '_blank');
      url.innerHTML = 'Link';
      purpose.innerHTML = productionTest.purpose;
      objective.innerHTML = productionTest.objective;
      approach.innerHTML = productionTest.approach;
      projectDuration.innerHTML = productionTest.projectDuration;
      funFact.innerHTML = productionTest.funFact;
    }

    if (id === certGen.projectTitle) {
      projectTitle.innerHTML = id;
      url.setAttribute('href', certGen.url);
      url.setAttribute('target', '_blank');
      url.innerHTML = 'Link';
      purpose.innerHTML = productionTest.purpose;
      objective.innerHTML = certGen.objective;
      approach.innerHTML = certGen.approach;
      projectDuration.innerHTML = certGen.projectDuration;
      funFact.innerHTML = certGen.funFact;
    }
  });
});
